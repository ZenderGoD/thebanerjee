...
const useResponsiveDimension = (
  ...
  useEffect(() => {
    ...
    const calc = () => {
      ...
      if (width <= 480 && (config as any)["mobile" + k]) {
        value = (config as any)["mobile" + k];
      } else if (width <= 768 && (config as any)["tablet" + k]) {
        value = (config as any)["tablet" + k];
      } else if (width <= 1024 && (config as any)["desktop" + k]) {
        value = (config as any)["desktop" + k];
      }
